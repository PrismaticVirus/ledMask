...
- Connect the first Data In pin to any pin on the Flora 
...
*NOTE: This code in its entirety was created using generative AI*
```cpp //this code was generated by an LLM
...
this is a weird thing with the voltage of the neopixels the easiest way to fix it is by lowering the brightness.
```cpp 
...
### Why doesn't it work?
There are a lot of things that can go wrong I would recommend checking everything your thread connections with a multi-meter 
